...
// Em seguida, crie uma lista de objetos "Pessoa" e ordene a lista em
...
// retorne uma lista com os números em ordem crescente, sem usar o
// método de ordenação da linguagem.
...
// 13. Crie uma função de ordem superior chamada operacaoMatematica que recebe
// dois números e uma função lambda.
// A função operacaoMatematica deve aplicar a função lambda aos dois
// números e retornar o resultado. Em seguida, crie algumas funções lambda
// para realizar operações matemáticas, como soma, subtração, multiplicação e divisão.
// Use a função de ordem superior para realizar essas operações com diferentes pares de
// números.

//14. Crie uma função de extensão chamada isPalindromo para a classe String que
// verifica se a string é um palíndromo. A função deve ignorar espaços em branco e
// ser case-insensitive (não distinguir maiúsculas de minúsculas).
// Em seguida, use essa função para verificar se algumas palavras são palíndromos.

//15. Vamos criar um programa que utilize funções de alta ordem para
// operar em um array de números inteiros. Você deve criar funções de alta
// ordem para realizar as seguintes operações: filtrarPares: Uma função que
// filtra e retorna apenas os números pares do array; dobrarValores: Uma função
// que dobra o valor de cada número no array; somarValores: Uma função que calcula a
// soma de todos os valores no array. Em seguida, crie um array de números inteiros e
// utilize as funções de alta ordem para realizar essas operações.
